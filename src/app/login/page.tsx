  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md p-8 space-y-4">
        <h1 className="text-3xl font-semibold text-white mt-3">Welcome Back, 👋</h1>
        <p className="text-1xl text-white font-extralight opacity-50 pt-2 pb-2">
          Sign in to your dashboard & start <br />
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end">
            <p className="text-white opacity-70 font-extralight">
              Forgot Password?
            </p>
          </div>
        </div>
        ...
        <button
          ...
          style={{
            color: "white",
            background: "linear-gradient(10deg, rgb(147, 63, 254) 0%, rgb(24, 200, 255) 100%)",
            // marginBottom:"50px"
          }}
          className={`w-full p-3 text-white rounded-lg ${
            isValidData ? "hover:bg-blue-600" : "cursor-pointer"
          } focus:outline-none`}
        >
          {loading ? (
        ...
        <div className="text-center pt-1 justify-end">
          <Link href="/signup" className="text-sm text-white opacity-90 hover:underline font-extralight">
